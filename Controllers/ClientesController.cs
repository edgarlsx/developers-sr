...
namespace Annexus_API.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        {
            return await _context.Clientes.Include("GrupoClientes").ToListAsync();
        }
        ...
        {
            var clientes = await _context.Clientes.Include("GrupoClientes").FirstOrDefaultAsync(x => x.Id == id);
